 ...
 * @version 1.0.0
 */
import { CandidateDto, toCandidateDto } from '../dtos/candidate.dto';
import { CandidateHelper, UserHelper } from '@job-finder/db/helpers';
...
export default class CandidateService {
   ...
   * @returns {Promise<CandidateDto>} The candidate profile data transfer object.
   */
  public getProfile = async (userId: number): Promise<CandidateDto> => {
    try {
      ...
      return toCandidateDto(foundCandidate);
    } catch (error) {
