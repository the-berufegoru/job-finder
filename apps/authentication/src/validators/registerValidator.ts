...
// Define the Joi schema for IBaseRegister with custom error messages
...
// Define the Joi schema for IAdminRegister
...
// Define the Joi schema for ICandidateRegister
...
// Define the Joi schema for IRecruiterRegister
